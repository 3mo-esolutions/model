import { Application, application, ApplicationLogo, component, html, routerLink } from '@3mo/model'
...
export class Photos extends Application {
	override get drawerContentTemplate() {
		return html`<mo-navigation-list-item icon='home' ${routerLink(new PageHome({}))}>Home</mo-navigation-list-item>`
	}
